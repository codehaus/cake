...
import static org.codehaus.cake.util.ops.ObjectOps.CONSTANT_OP;
import static org.codehaus.cake.util.ops.ObjectOps.MAX_REDUCER;
import static org.codehaus.cake.util.ops.ObjectOps.MIN_REDUCER;
...
public class ObjectOpsTest {
    ...
    /**
     * Tests that {@link ObjectOps#compoundMapper(Op, Op)} throws a {@link NullPointerException} when invoked with a
