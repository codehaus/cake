...
/**
 * A <code>cache loader</code> is used for transparent loading or creation of values by a
...
public interface SimpleCacheLoader<K, V> {
     ...
     * @param attributes
     *            a map of attributes that can the loader can inspect for attributes needed while
     *            loading or it can be updated by the cache loader with additional attributes
