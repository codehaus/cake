 ...
 * {@link Cache}. All general-purpose <tt>Cache</tt> implementation classes
 * should have a constructor with a single argument taking a CacheConfiguration.
 * <p>
 * <b>Usage Examples.</b> The following creates a new cache with the name
 * <I>MyCache</I>. The cache can hold a maximum of 1000 elements and uses a
 * least-recently-used policy to determine which elements to evict when the
 * specified maximum size has been reached. Finally, the cache and all of its
 * services are registered as a mbean with the
 * {@link java.lang.management.ManagementFactory#getPlatformMBeanServer()
 * platform <tt>MBeanServer</tt>} using the name of the cache. The cache is
 * 
 * <pre>
 * CacheConfiguration&lt;String, Integer&gt; cc = CacheConfiguration
 * 		.newConfiguration(&quot;MyCache&quot;);
...
public class CacheConfiguration<K, V> extends ContainerConfiguration<Cache> {
	...
	/**
	 * Returns a configuration object that can be used to register which
	 * attributes the cache keep count of.
	 * 
	...
	/**
	 * Returns a configuration object that can be used to control how exceptions
	 * are handled within the cache
	 * 
	...
	/**
	 * Returns a configuration object that can be used to control how loading is
	 * done in the cache.
	 * 
	...
	/**
	 * Returns a configuration object that can be used to control how services
	...
	/**
	 * Returns a configuration object that can be used to control how cache
	...
	/**
	 * Creates a new CacheConfiguration with default settings and the specified
	 * name as the name of the cache.
	 * 
	 * @param name
