 ...
 * {@link MapManagementConfiguration#setEnabled(boolean)} has been set to
 * <code>true</code>.
 * 
...
public interface CacheLoadingMXBean {
     ...
     * {@link CacheLoadingConfiguration#getNeedsReloadFilter()}. If no filter has been
     * set, calls to this method is ignored.
     */
    void loadAll();
}
