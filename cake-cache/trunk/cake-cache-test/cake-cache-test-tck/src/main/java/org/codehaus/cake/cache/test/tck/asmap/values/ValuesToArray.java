 ...
 * @version $Id$
 */
public class ValuesToArray extends AbstractAsMapTCKTest {
    ...
    public void toArray() {
       ...
       init(5);
        ...
        assertEquals(new HashSet(M1_TO_M5_VALUES), new HashSet(Arrays.asList(asMap().values().toArray(new String[5]))));
    }
