...
public class ModifiedTime extends AbstractAttributeTest {
    ...
    public void loadedAttribute() {
        loader.withLoader(M1).addAttribute(ENTRY_DATE_MODIFIED, 5l);
        loader.withLoader(M2).addAttribute(ENTRY_DATE_MODIFIED, 6l);
        loader.withLoader(M3).addAttribute(ENTRY_DATE_MODIFIED, 7l);
        loader.withLoader(M4).addAttribute(ENTRY_DATE_MODIFIED, 8l);
