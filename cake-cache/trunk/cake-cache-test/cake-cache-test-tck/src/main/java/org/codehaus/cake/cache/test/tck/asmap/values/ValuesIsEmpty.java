 ...
 * @version $Id$
 */
public class ValuesIsEmpty extends AbstractAsMapTCKTest {
    ...
    public void isEmptyValues() {
        assertTrue(newCache(0).asMap().values().isEmpty());
        assertFalse(newCache(5).asMap().values().isEmpty());
    }
    ...
    public void isEmptyShutdown() throws InterruptedException {
       init(5);
        ...
        boolean isEmpty = asMap().values().isEmpty();
