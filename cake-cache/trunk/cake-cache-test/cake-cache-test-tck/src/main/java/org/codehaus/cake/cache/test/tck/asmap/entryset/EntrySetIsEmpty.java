 ...
 * @version $Id$
 */
public class EntrySetIsEmpty extends AbstractAsMapTCKTest {
    ...
    public void isEmptyEntrySet() {
        assertTrue(newCache(0).asMap().entrySet().isEmpty());
        assertFalse(newCache(5).asMap().entrySet().isEmpty());
    }
    ...
    public void isEmptyShutdown() throws InterruptedException {
        ...
        boolean isEmpty = asMap().entrySet().isEmpty();
