...
public class VariousLoading {
    public static void main(String[] args) {
        ...
        // (Ordinary) loading will only load the specified elements if they are either not present in the cache or
        // expired or needs refreshing
        loading.load("http://www.google.com"); // will load the specified url only if it is not already present in the
                                                // cache or if it is expired or needs refreshing
