...
public class AtrStubs {
    ...
    public final static CharAttribute C_MAX_VALUE = new CharAttribute("C_MAX_VALUE", Character.MAX_VALUE) {};
    public final static CharAttribute C_MIN_VALUE = new CharAttribute("C_MIN_VALUE", Character.MIN_VALUE) {};
    ...
    public final static DoubleAttribute D_MAX_VALUE = new DoubleAttribute("D_MAX_VALUE", Double.MAX_VALUE) {};
    public final static DoubleAttribute D_MIN_VALUE = new DoubleAttribute("D_MIN_VALUE", Double.MIN_VALUE) {};
    ...
    public final static FloatAttribute F_MAX_VALUE = new FloatAttribute("F_MAX_VALUE", Float.MAX_VALUE) {};
    public final static FloatAttribute F_MIN_VALUE = new FloatAttribute("F_MIN_VALUE", Float.MIN_VALUE) {};
    ...
    public final static IntAttribute I_MAX_VALUE = new IntAttribute("I_MAX_VALUE", Integer.MAX_VALUE) {};
    public final static IntAttribute I_MIN_VALUE = new IntAttribute("I_MIN_VALUE", Integer.MIN_VALUE) {};
    ...
    public final static ObjectAttribute<String> O_1 = new ObjectAttribute<String>("O_1", String.class, "1.5") {};
    public final static ObjectAttribute<String> O_2 = new ObjectAttribute<String>("O_2", String.class, "15") {};
    public final static ObjectAttribute<String> O_3 = new ObjectAttribute<String>("O_3", String.class, null) {};
    ...
    public final static ShortAttribute S_MAX_VALUE = new ShortAttribute("S_MAX_VALUE", Short.MAX_VALUE) {};
    public final static ShortAttribute S_MIN_VALUE = new ShortAttribute("S_MIN_VALUE", Short.MIN_VALUE) {};
