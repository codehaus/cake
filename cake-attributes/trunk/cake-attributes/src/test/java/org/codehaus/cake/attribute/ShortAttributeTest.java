...
//        assertFalse(new ShortAttribute((short) 3) {}.getName().equals(new ShortAttribute((short) 3) {}.getName()));
    ...
    public void comparator() {
        GetAttributer wa1 = ATR1.singleton((short) 1);
        GetAttributer wa2 = ATR1.singleton((short) 2);
        GetAttributer wa22 = ATR1.singleton((short) 2);
        GetAttributer wa3 = ATR1.singleton((short) 3);
