...
//        assertFalse(new FloatAttribute(3F) {}.getName().equals(new FloatAttribute(3F) {}.getName()));
    ...
    public void comparator() {
        GetAttributer wa1 = ATR1.singleton(1F);
        GetAttributer wa2 = ATR1.singleton(2F);
        GetAttributer wa22 = ATR1.singleton(2F);
        GetAttributer wa3 = ATR1.singleton(3F);
    ...
    public void set() {
        ...
        ATR100.set(am, 10F);
        assertEquals(10F, am.get(ATR100),0);
        
        ATR100.set(withAtr(am), -111F);
        assertEquals(-111F, am.get(ATR100),0);
        
        ATR100.set(am, Float.valueOf(111F));
        assertEquals(111F, am.get(ATR100),0);
        
        ATR100.set(am, Float.MAX_VALUE);
        assertEquals(Float.MAX_VALUE, am.get(ATR100),0);
    }
