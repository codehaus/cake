...
//        assertFalse(new ByteAttribute((byte) 3) {}.getName().equals(new ByteAttribute((byte) 3) {}.getName()));
    ...
    public void comparator() {
        GetAttributer wa1 = ATR1.singleton((byte) 1);
        GetAttributer wa2 = ATR1.singleton((byte) 2);
        GetAttributer wa22 = ATR1.singleton((byte) 2);
        GetAttributer wa3 = ATR1.singleton((byte) 3);
