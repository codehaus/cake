...
public class GenerateAttributeMap extends GeneratorBuilder {

    public static void main(String[] args) throws Exception {
        new GenerateAttributeMap().generate();
    ...
    public void generate() throws Exception {
        ...
        gb.setClassName("AttributeMap.tmp");
        // gb.generateMany("attribute/attributemap.vm", "cake-attributes/trunk/cake-attributes/src/main/java/",
        // GenerationType.ALL);
        gb.generateMany("attribute/attributemap.vm", "cake-attributes/cake-attributes/src/main/java/",
                GenerationType.ALL);
    }
}
