...
public class RunManyAfterSimpleArguments extends AbstractTCKTest<Container, ContainerConfiguration> {
    ...
    public static class DisposableNoArg extends AssertableState {
        ...
        public void azzzz() {
            advance("-[1/2]>Starting");
        }
        @RunAfter(State.SHUTDOWN)
        public void ccaaa() {
            advance("Running-[2/3]>Shutdown");
        }
        ...
        @RunAfter(State.STARTING)
        public void zzzz() {
            advance("-[2/2]>Starting");
        }

        @RunAfter(State.SHUTDOWN)
        public void aaa() {
            advance("Running-[1/3]>Shutdown");
        }
    }
