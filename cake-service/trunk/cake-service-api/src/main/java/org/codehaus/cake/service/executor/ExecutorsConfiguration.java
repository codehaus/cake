...
public class ExecutorsConfiguration {
    ...
    /**
     * Returns the {@link ExecutorsManager} or <code>null</code> if no executor manager has been set.
     * 
     * @return the {@link ExecutorsManager} or <code>null</code> if no executor manager has been set
    ...
    /**
     * Sets the ExecutorManager that should be used. If no ExecutorManager is set one will be created automatically if
     * needed.
     * 
