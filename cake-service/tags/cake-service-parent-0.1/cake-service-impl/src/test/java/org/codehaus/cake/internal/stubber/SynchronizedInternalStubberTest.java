...
@TckImplementationSpecifier(SynchronizedInternalStubber.class)
public class SynchronizedInternalStubberTest extends AbstraktStubberTCKTst {

    @Test
    public void testInstance() {
        assertTrue(c instanceof SynchronizedInternalStubber);
    }
}
