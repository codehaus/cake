...
@TckImplementationSpecifier(UnsynchronizedInternalStubber.class)
public class UnsynchronizedInternalStubberTest extends AbstraktStubberTCKTst {

    @Test
    public void testInstance() {
        assertTrue(c instanceof UnsynchronizedInternalStubber);
    }
}
